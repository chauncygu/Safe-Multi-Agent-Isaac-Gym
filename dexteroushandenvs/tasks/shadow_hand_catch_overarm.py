...
class ShadowHandCatchOverarm(BaseTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        shadow_hand_start_pose.r = gymapi.Quat().from_euler_zyx(1.57 + 0.78, 3.14, 0)

        shadow_another_hand_start_pose = gymapi.Transform()
        shadow_another_hand_start_pose.p = gymapi.Vec3(0, -1.25, 0.5)
        shadow_another_hand_start_pose.r = gymapi.Quat().from_euler_zyx(1.57 + 0.78, 3.14, 3.1415)

        object_start_pose = gymapi.Transform()
        object_start_pose.p = gymapi.Vec3()
        object_start_pose.p.x = shadow_hand_start_pose.p.x
        pose_dy, pose_dz = 0.25, 0.3
    ...
    def reset_target_pose(self, env_ids, apply_reset=False):
        ...
        self.goal_states[env_ids, 1] -= 1.75
