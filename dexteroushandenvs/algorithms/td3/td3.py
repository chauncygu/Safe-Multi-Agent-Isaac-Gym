...
from algorithms.td3 import ReplayBuffer

from algorithms.td3 import MLPActorCritic
...
class TD3:
    ...
    def __init__(self,
        ...
        self.storage = ReplayBuffer(vec_env.num_envs, replay_size, self.observation_space.shape,
    ...
    def update(self):
        ...
        for indices in batch:
            ...
            nextobs_batch = self.storage.next_observations.view(-1, *self.storage.observations.size()[2:])[indices]
            if self.asymmetric:
