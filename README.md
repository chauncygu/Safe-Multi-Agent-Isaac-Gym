...
This repository is an extention of [DexterousHands](https://github.com/PKU-MARL/DexterousHands), which contains complex dexterous hand RL environments for the NVIDIA Isaac Gym high performance environments described [in the NeurIPS 2021 Datasets and Benchmarks paper](https://openreview.net/forum?id=fgFBtYgJQX_)
